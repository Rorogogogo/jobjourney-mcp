...
export function detectAggregator(url) {
    try {
        ...
        if (hostname.includes("linkedin.com"))
            return "linkedin";
        if (hostname.includes("seek.com.au") || hostname.includes("seek.co.nz"))
            return "seek";
 ...
 */
export async function resolveApplyUrl(url, browser, onProgress) {
...
async function clickApplyAndCaptureUrl(page, site, context, onProgress, originalUrl) {
    const selectors = {
        linkedin: [
