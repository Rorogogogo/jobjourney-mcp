...
export function detectWorkArrangement(text) {
...
export function detectExperienceLevel(text) {
    ...
    if (/\b((?:team|tech|technical|engineering|product)\s+lead|lead\s+(?:developer|engineer|designer|data)|manager|head\s+of|director|vp)\b/i.test(text) &&
