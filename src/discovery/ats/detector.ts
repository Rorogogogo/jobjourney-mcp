...
export function extractKnownAtsUrls(text: string): string[] {
...
export function normalizeAtsUrlCandidate(value: string): string | null {
  if (!value) {
    return null;
  }
...
export function unwrapLinkedInRedirect(value: string): string {
  try {
...
function extractCompanyIdentifier(
